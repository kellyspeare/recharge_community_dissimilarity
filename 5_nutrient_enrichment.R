...
#  
# 5_nutrient_enrichment

# ----------------------------------------------------------------------- #

# this script analyzes data on water column nutrients from water samples 
# collected within experimental plots 
# Plots Figures for supplement
...
water_nutrients<-read.csv("data/water_nutrients.csv", header=TRUE, stringsAsFactors = TRUE)
...
# Phosphate - analyzed through time --------------------------------------------
