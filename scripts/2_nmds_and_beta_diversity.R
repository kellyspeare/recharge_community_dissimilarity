...
# NOTE! when you make the species matrix dataframes make sure that you don't include Sum_Macroalgae or Sum_Coral in the species matrix
...
fun_groups$functional_group<-factor(fun_groups$functional_group, c("branching corals","encrusting corals","other corals","hydrocorals","fungids","soft corals",
                                                 "CCA", "calcareous algae","filamentous algae","foliose algae","macrophytes","microalgae","other macroalgae",
...
bray_mod0<-betadisper(bray_dist0, meta0$Herb_Trt, type = "median")
anova(bray_mod0) # NS
permutest(bray_mod0, pairwise = TRUE, permutations = 99)
plot(bray_mod0)
boxplot(bray_mod0)
TukeyHSD(bray_mod0)
...
bray_mod12<-betadisper(bray_dist12, meta12$Herb_Trt, type = "median")
anova(bray_mod12) #reported anova results
permutest(bray_mod12, pairwise = TRUE, permutations = 999) #permutest results are the same but did not report
plot(bray_mod12)
boxplot(bray_mod12)
TukeyHSD(bray_mod12)
...
# -----------------------------------------------------------------------------#
# Note, paper presents the results with the above method starting at line 289. 
# but results w/the method below are quantitatively the same.
...
sp_matrix0_twofac<-as.matrix(cover0[,c(13:56)])
bray_disT0_twofac<-vegdist(sp_matrix0_twofac, method = "bray")
bray_mod0_twofac<-betadisper(bray_disT0_twofac, meta0_twofac$Herb_Nuts_Trt, type = "median")
...
sp_matrix12_twofac<-as.matrix(cover12[,c(13:56)])
bray_dist12_twofac<-vegdist(sp_matrix12_twofac, method = "bray")
bray_mod12_twofac<-betadisper(bray_dist12_twofac, meta12_twofac$Herb_Nuts_Trt, type = "median")
...
#write.csv(sim_herb_df, "model outputs/simper/sim_herb_df_v2.csv")
...
#write.csv(sim_nutrients_df, "model outputs/simper/sim_nutrients_df_v2.csv")

# -----------------------------------------------------------------------------#
#  Evaluating how beta dispersion varied through time --------------------------
# -----------------------------------------------------------------------------#
...
cover0_twofac<-subset(cover_twofac, Time_point==0)
cover1_twofac<-subset(cover_twofac, Time_point==1)
cover2_twofac<-subset(cover_twofac, Time_point==2)
cover3_twofac<-subset(cover_twofac, Time_point==3)
cover4_twofac<-subset(cover_twofac, Time_point==4)
cover6_twofac<-subset(cover_twofac, Time_point==6)
cover8_twofac<-subset(cover_twofac, Time_point==8)
cover9_twofac<-subset(cover_twofac, Time_point==9)
cover10_twofac<-subset(cover_twofac, Time_point==10)
cover11_twofac<-subset(cover_twofac, Time_point==11)
cover12_twofac<-subset(cover_twofac, Time_point==12)

# making the species matrix for each timepoint
sp_matrix0_twofac<-as.matrix(cover0_twofac[,c(13:56)])
sp_matrix1_twofac<-as.matrix(cover1_twofac[,c(13:56)])
sp_matrix2_twofac<-as.matrix(cover2_twofac[,c(13:56)])
sp_matrix3_twofac<-as.matrix(cover3_twofac[,c(13:56)])
sp_matrix4_twofac<-as.matrix(cover4_twofac[,c(13:56)])
sp_matrix6_twofac<-as.matrix(cover6_twofac[,c(13:56)])
sp_matrix8_twofac<-as.matrix(cover8_twofac[,c(13:56)])
sp_matrix9_twofac<-as.matrix(cover9_twofac[,c(13:56)])
sp_matrix10_twofac<-as.matrix(cover10_twofac[,c(13:56)])
sp_matrix11_twofac<-as.matrix(cover11_twofac[,c(13:56)])
sp_matrix12_twofac<-as.matrix(cover12_twofac[,c(13:56)])

#metadata for each timepoint
meta0_twofac<-cover0_twofac[,c(1:12,57)]
meta1_twofac<-cover1_twofac[,c(1:12,57)]
meta2_twofac<-cover2_twofac[,c(1:12,57)]
meta3_twofac<-cover3_twofac[,c(1:12,57)]
meta4_twofac<-cover4_twofac[,c(1:12,57)]
meta6_twofac<-cover6_twofac[,c(1:12,57)]
meta8_twofac<-cover8_twofac[,c(1:12,57)]
meta9_twofac<-cover9_twofac[,c(1:12,57)]
meta10_twofac<-cover10_twofac[,c(1:12,57)]
meta11_twofac<-cover11_twofac[,c(1:12,57)]
meta12_twofac<-cover12_twofac[,c(1:12,57)]
...
bray_mod0_twofac<-betadisper(bray_dist0_twofac, meta0_twofac$Twofac, type = "median")
bray_mod1_twofac<-betadisper(bray_dist1_twofac, meta1_twofac$Twofac, type = "median")
bray_mod2_twofac<-betadisper(bray_dist2_twofac, meta2_twofac$Twofac, type = "median")
bray_mod3_twofac<-betadisper(bray_dist3_twofac, meta3_twofac$Twofac, type = "median")
bray_mod4_twofac<-betadisper(bray_dist4_twofac, meta4_twofac$Twofac, type = "median")
bray_mod6_twofac<-betadisper(bray_dist6_twofac, meta6_twofac$Twofac, type = "median")
bray_mod8_twofac<-betadisper(bray_dist8_twofac, meta8_twofac$Twofac, type = "median")
bray_mod9_twofac<-betadisper(bray_dist9_twofac, meta9_twofac$Twofac, type = "median")
bray_mod10_twofac<-betadisper(bray_dist10_twofac, meta10_twofac$Twofac, type = "median")
bray_mod11_twofac<-betadisper(bray_dist11_twofac, meta11_twofac$Twofac, type = "median")
bray_mod12_twofac<-betadisper(bray_dist12_twofac, meta12_twofac$Twofac, type = "median")

# Anova on Betadisepr models - Testing for differences in dispersion among 8 groups (one-way test)
# results for Table S2
anova(bray_mod0_twofac)
...
# testing for interaction in two-way permanova - testing for differences in location of group medians
# write.csv(adonis2(sp_matrix0_twofac ~ Herb_Trt*Nutrient_Trt, data=meta0_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod0_twofac.csv")
# write.csv(adonis2(sp_matrix1_twofac ~ Herb_Trt*Nutrient_Trt, data=meta1_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod1_twofac.csv")
# write.csv(adonis2(sp_matrix2_twofac ~ Herb_Trt*Nutrient_Trt, data=meta2_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod2_twofac.csv")
# write.csv(adonis2(sp_matrix3_twofac ~ Herb_Trt*Nutrient_Trt, data=meta3_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod3_twofac.csv")
# write.csv(adonis2(sp_matrix4_twofac ~ Herb_Trt*Nutrient_Trt, data=meta4_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod4_twofac.csv")
# write.csv(adonis2(sp_matrix6_twofac ~ Herb_Trt*Nutrient_Trt, data=meta6_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod6_twofac.csv")
# write.csv(adonis2(sp_matrix8_twofac ~ Herb_Trt*Nutrient_Trt, data=meta8_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod8_twofac.csv")
# write.csv(adonis2(sp_matrix9_twofac ~ Herb_Trt*Nutrient_Trt, data=meta9_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod9_twofac.csv")
# write.csv(adonis2(sp_matrix10_twofac ~ Herb_Trt*Nutrient_Trt, data=meta10_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod10_twofac.csv")
# write.csv(adonis2(sp_matrix11_twofac ~ Herb_Trt*Nutrient_Trt, data=meta11_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod11_twofac.csv")
# write.csv(adonis2(sp_matrix12_twofac ~ Herb_Trt*Nutrient_Trt, data=meta12_twofac, permutations = 999, method = "bray", by = "terms"), "model outputs/adonis/adonis_bray_mod12_twofac.csv")
...
# Days_since_start              92.5547  1  < 2.2e-16 ***
# Herb_Trt:Nutrient_Trt          1.1758  3    0.75883    
# Herb_Trt:Days_since_start     36.8688  3  4.905e-08 ***
...
# compare slopes - herb trt
emtrends(dist.mod.2, pairwise ~ Herb_Trt, var = "Days_since_start")
cld(emtrends(dist.mod.2, pairwise ~ Herb_Trt, var = "Days_since_start"))

# compare slopes - nutrient trt
emtrends(dist.mod.2, pairwise ~ Nutrient_Trt, var = "Days_since_start")
...
dist_nut_plot<-ggplot()+ 
  geom_point(data=betadisp_twofac_df, aes(x=Days_since_start, y=distances, color=Nutrient_Trt, fill=Nutrient_Trt, shape=Nutrient_Trt),
             position=position_jitter(w = 25), size=2, stroke = 1, alpha=0.5)+
  geom_ribbon(data=dist_nut_pred, aes(x=Days_since_start, ymin=yvar-SE, ymax=yvar+SE, fill=Nutrient_Trt, group=Nutrient_Trt),alpha= 0.3) +
  geom_line(data=dist_nut_pred, aes(x=Days_since_start, y = yvar, group=Nutrient_Trt, color=Nutrient_Trt), size = 0.9)+
